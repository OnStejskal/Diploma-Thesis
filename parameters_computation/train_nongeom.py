...
from dataset import NonGeomParameterDataset, mask_all_segments,mask_plaque, cat_segmentation_with_image, img_and_plaque_mask, img_and_all_segments_mask, img_and_one_hot_segmentation
import torch
...
#############################################################
### This file is for the training of the classification   ###
...
#####################################################
# EXPERIMENT_NAME = "FINAL_homo_maag_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_acnn_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "ACNN_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_segan_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "SEGAN_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_unet_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "UNETPAPER_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)
#####################################################
# EXPERIMENT_NAME = "FINAL_homo_maag_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "MAAG_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_acnn_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "ACNN_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_segan_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "SEGAN_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_unet_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "UNETPAPER_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)
...
# AT_WHICH_LAYER_IS_CAT_OR_MASK = 6
#####################################################
# EXPERIMENT_NAME = "FINAL_echo_maag_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_acnn_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "ACNN_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_segan_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "SEGAN_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_unet_fix_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "UNETPAPER_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)
#####################################################
# EXPERIMENT_NAME = "FINAL_echo_maag_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "MAAG_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_acnn_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "ACNN_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_segan_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "SEGAN_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_unet_dynamic_cat_start"
# MASKING_FUCNTION = cat_segmentation_with_image
# DATASET_NAME = "UNETPAPER_DYNAMIC"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=7, echogenicity=ECHOGENECITY)

# !!!!!!!!!!!!!!!!!!! cat middle, mask middle, mask start!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# ECHOGENECITY = False
# EXPERIMENT_NAME = "FINAL_homo_maag_fix_mask_start"
# MASKING_FUCNTION = mask_plaque
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=3, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_maag_fix_mask_middle"
# MASKING_FUCNTION = img_and_plaque_mask
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParamsMaskMiddle(pretrained=True, input_img_dim=3, input_seg_dim=1, echogenicity= ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_homo_maag_fix_cat_middle"
# MASKING_FUCNTION = img_and_one_hot_segmentation
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParamsMaskMiddle(pretrained=True, input_img_dim=3, input_seg_dim=4, echogenicity= ECHOGENECITY)


# ECHOGENECITY = True
# EXPERIMENT_NAME = "FINAL_echo_maag_fix_mask_start"
# MASKING_FUCNTION = mask_plaque
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParams(pretrained=True, input_dim=3, echogenicity=ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_maag_fix_mask_middle"
# MASKING_FUCNTION = img_and_plaque_mask
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParamsMaskMiddle(pretrained=True, input_img_dim=3, input_seg_dim=1, echogenicity= ECHOGENECITY)

# EXPERIMENT_NAME = "FINAL_echo_maag_fix_cat_middle"
# MASKING_FUCNTION = img_and_one_hot_segmentation
# DATASET_NAME = "MAAG_FIX"
# TRANSFORMATIONS_CUSTOM = TRANSFORMATIONS_CUSTOM_COMPLEX
# MODEL = Resnet18NonGeomParamsMaskMiddle(pretrained=True, input_img_dim=3, input_seg_dim=4, echogenicity= ECHOGENECITY)
...
def train_multi_input_model(
    ...
    batch_size = 2
    weights_echo = torch.tensor([1.25, 0.9, 0.75, 1.2 ]).to(device)
    weights_homo = torch.tensor([1.6, 0.7]).to(device)
    loss_function = CrossEntropyLoss(weights_echo if echogenicity else weights_homo)
    train_dataset = NonGeomParameterDataset(TRAIN_IMAGES_PATH, TRAIN_SEGMENTATIONS_PATH, LABELS_PATH,masking_function, echogenicity, transformations_torch = TRANSFORMATION_TORCH, transformations_custom = TRANSFORMATION_CUSTOM)
    val_dataset = NonGeomParameterDataset(VAL_IMAGES_PATH, VAL_SEGMENTATIONS_PATH, LABELS_PATH,masking_function, echogenicity, transformations_torch = TRANSFORMATION_TORCH, transformations_custom = TRANSFORMATIONS_CUSTOM_NO)
    test_dataset = NonGeomParameterDataset(TEST_IMAGES_PATH, TEST_SEGMENTATIONS_PATH, LABELS_PATH,masking_function, echogenicity, transformations_torch = TRANSFORMATION_TORCH, transformations_custom = TRANSFORMATIONS_CUSTOM_NO)
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            for images, labels, name in val_dataloader:
                ...
                # print(output_classes.cpu().numpy())
                # print(vlabels.cpu().numpy())
