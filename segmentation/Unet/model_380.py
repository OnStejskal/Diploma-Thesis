...
class Unet380(Module):
    ...
    def __init__(
        ...
        """
        super(Unet380, self).__init__()

        self.L0 = LeftBlock(3, 64, (3, 3), 1, 1, pool_kernel_size, dropout_p)
        self.L1 = LeftBlock(64, 128, (3, 3), 1, 1, pool_kernel_size, dropout_p)
        self.L2 = LeftBlock(128, 256, (3, 3), 1, 1, pool_kernel_size, dropout_p)
        self.L3 = LeftBlock(256, 512, (3, 3), 1, 1, pool_kernel_size, dropout_p)
        # Assuming no further downsampling is needed for a 380x380 input
        self.L4 = LeftBlock(512, 1024, (3, 3), 1, 1, pool_kernel_size, dropout_p)
        
        # Initialize right blocks with adjusted parameters
        # Note: The channel numbers for the upsampling blocks will have to be adjusted
        # based on the concatenation with the corresponding left block outputs.
        self.R3 = RightBlock(1024 + 512, 512, (3, 3), 1, 1, up_scale_factor, dropout_p)
        self.R2 = RightBlock(512 + 256, 256, (3, 3), 1, 1, up_scale_factor, dropout_p)
        self.R1 = RightBlock(256 + 128, 128, (3, 3), 1, 1, up_scale_factor, dropout_p)
        self.R0 = RightBlock(128 + 64, 64, (3, 3), 1, 1, up_scale_factor, dropout_p)
